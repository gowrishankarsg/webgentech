...
if(isset($_POST['submit']))	{
	...
	$update_query	= "UPDATE products SET `name` = '".$name."',`price` = '".$price."',`description` = '".$description."' WHERE productId = '".$_GET['pId']."'";
                     ...
                     <div class="ibox">
                        <div class="ibox-content">
							<div class="ibox">
								...
								<?php
								$query		=	"SELECT * FROM products WHERE productId = '".$_GET['pId']."'";
								...
								<div class="ibox-content">  
									<div class="form-group">												
										<div class="col-sm-4">
											...
											<input type="text" class="form-control" name="name" value="<?php echo $result['name'];?>" placeholder="Product Name" />   
										</div>	
										<div class="col-sm-4">
											<label>product Price</label>								
											<input type="text" class="form-control" name="price" value="<?php echo $result['price'];?>"placeholder="Price" />
										</div>	
										<div class="col-sm-4">
											<label>Description</label>
											<textarea class="form-control" name="description" placeholder="Description"><?php echo $result['description'];?></textarea>
										</div>
									</div>
